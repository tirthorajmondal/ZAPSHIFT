import customerTop from '../../../assets/benifits/customer-top.png';
...
const CustomerSaying = () => {
    ...
    return (
        <section className=''>
            <img src={customerTop} className='w-fit mx-auto mb-4' alt="" />
            <SectionTitleDesc title={'What our customers are saying'} desc={'Enhance posture, mobility, and well-being effortlessly with Posture Pro. Achieve proper alignment, reduce pain, and strengthen your body with ease!'} titleStyle={'text-secondary'} />
